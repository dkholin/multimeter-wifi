...
.tags{display:flex;gap:.5rem;min-height:1.6rem;flex-wrap:wrap}.tag{font-size:.85rem;font-weight:600;letter-spacing:.08em;color:#33453a;padding:.15rem .55rem;border-radius:6px}.tag.on{color:#0d1210;background:#7ee39b}.tag.warn.on{background:#f0c85a}
...
<section class=lcd><div class=tags><span id=dc class=tag>DC</span><span id=ac class=tag>AC</span><span id=auto class=tag>AUTO</span><span id=hold class="tag warn">HOLD</span><span id=max class=tag>MAX</span><span id=min class=tag>MIN</span><span id=diode class=tag>DIODE</span><span id=continuity class=tag>CONT</span></div>
<div class=read><span id=number class=number>—</span><span id=unit class=unit></span></div></section>
